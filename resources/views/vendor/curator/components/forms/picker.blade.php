    ...
    <div class="curator-media-picker w-full">
        <ul
            @class([
                ...
                'bg-white border border-gray-300 rounded-lg shadow-sm divide-y divide-gray-300 dark:border-gray-700 dark:text-white dark:divide-gray-700 dark:bg-white/5' => $itemsCount > 0 && $shouldDisplayAsList,
            ])
            x-sortable
            ...
            @foreach ($items as $uuid => $item)
                ...
                >
                    ...
                    @else
                        <div
                            @class([
                                'relative block w-full border border-gray-300 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:text-white flex justify-center checkered',
